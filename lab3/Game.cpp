...
{
	if(command == "east")
		return rooms[now].isEast();
	else if(command == "west")
		return rooms[now].isWest();
	else if(command == "south")
		return rooms[now].isSouth();
	else if(command == "north")
		return rooms[now].isNorth();
	else if(command == "up")
		return rooms[now].isUp();
	else if(command == "down")
		return rooms[now].isDown();
	else{
